...
validation_image_map = [
  ...
  "pictures/piano.jpg",
  "pictures/whale.jpg",
] # Permet d'avoir un jeu d'images en local, indépendant de la partie réseau pour valider la configuration du réseau de neurones et la classification d'images sans la partie réseau
